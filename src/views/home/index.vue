        ...
        <el-card>
          <el-row :gutter="40">
            <el-col :span="6">
              ...
              <p class="chart-item-desc text-c">Visits</p>
            </el-col>
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-histogram
              ...
              <p class="chart-item-desc text-c">Page Views</p>
            </el-col>
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-line
              ...
              <p class="chart-item-value text-c">
                <count-to style="font-size: 22px" :start="0" :end="25">
                  <span slot="right"> %</span>
                </count-to>
              </p>
              <p class="chart-item-desc text-c">Returning Visits</p>
            </el-col>
            <el-col :span="6">
              <div class="chart-item-warpper">
                <ve-line
              ...
              <p class="chart-item-desc text-c">Page / Visits</p>
            </el-col>
          </el-row>
        </el-card>
      </el-col>
            ...
            <el-card v-loading="loadingUnique">
              <div slot="header" class="clearfix">
                <div class="card-title-box">
                  ...
                  <div>
                    <svg-icon
                      class="icon-action-item"
                      icon-class="refresh"
                      @click="refreshLoadUniqueData"
                    ></svg-icon>
                    <svg-icon
                      class="icon-action-item"
                      icon-class="close"
                      @click="showUnique = false"
                    ></svg-icon>
                  </div>
                </div>
              </div>
              ...
              <el-row :gutter="20">
                <el-col :span="6">
                  <div class="unique-item" style="flex-direction: column">
                    ...
                    <p style="color: #999; margin-top: 10px">Unique visitors</p>
                  </div>
                </el-col>
                <el-col :span="9">
                ...
                <div class="card-title-box">
                  ...
                  <div>
                    <svg-icon
                      class="icon-action-item"
                      icon-class="refresh"
                      @click="refreshLoadUniquePcData"
                    ></svg-icon>
                    <svg-icon
                      class="icon-action-item"
                      icon-class="close"
                      @click="showUniquePc = false"
                    ></svg-icon>
                  </div>
                </div>
              </div>
...
@import "src/assets/stylues/home.scss";
.home {
